...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Сен 02 2018 г., 11:46
...
(1, 'Ленина', '192.168.1.1', 'Исполнитель  1', 'Администратор', '2018-09-02', 'коммент', 'Создана'),
...
(1, 'Администратор', '1', 'admin'),
(3, 'Исполнитель', '1', 'executor'),
(4, 'Наблюдатель', '1', 'observer'),
(5, 'Оператор', '1', 'operator');
